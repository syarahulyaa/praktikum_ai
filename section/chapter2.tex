...
\subsection{Teori}
\begin{enumerate}
\item binary classification dilengkapi ilustrasi gambar
...
\item supervised learning dan unsupervised learning dan clustering dengan ilustrasi gambar
...
\item evaluasi dan akurasi dari buku dan disertai ilustrasi contoh
dengan gambar
...
\item bagaimana cara membuat dan membaca confusion matrix, buat confusion matrix
\begin{enumerate}
...
\item bagaimana K-fold cross validation bekerja dengan gambar ilustrasi
...
\item decision tree dengan gambar ilustrasi
...
\item Information gain dan entropi dengan gambar ilustrasi
