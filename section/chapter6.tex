...
\lstinputlisting[firstline=8, lastline=20]{src/1164085/6-roza.py}
...
\begin{itemize}
\item Kodingan:
\lstinputlisting[firstline=8, lastline=20]{src/1164085/7-roza.py}
...
\begin{itemize}
\item Kodingan:
\lstinputlisting[firstline=8, lastline=20]{src/1164085/8-roza.py}
...
\begin{itemize}
\item Kodingan:
\lstinputlisting[firstline=8, lastline=20]{src/1164085/9-roza.py}
...
\begin{itemize}
\item Kodingan:
\lstinputlisting[firstline=8, lastline=20]{src/1164085/10-roza.py}
...
\begin{itemize}
\item Kodingan:
\lstinputlisting[firstline=8, lastline=20]{src/1164085/11-roza.py}
...
\par 
\par
\lstinputlisting[firstline=8, lastline=20]{src/1164072/6-fadila.py}
\par
\par
\par
...
\caption{Pemisahan Data Training Dan Dataset - fadila}
\label{pemisahan-data-train-set-fadila}
\end{figure}
\par
\par
\par
\begin{figure}[!hbtp]
\centering
\includegraphics[scale=0.2]{figures/pemisahan-data-train-set-2-fadila.jpg}
\caption{Pemisahan Data Training Dan Dataset 2 - fadila}
\label{pemisahan-data-train-set-2-fadila}
\end{figure}
\par
\end{itemize}
\end{itemize}
...
\par Penjelasan :
\item Ilustrasi Gambar : \ref{fungsi-sequential-fadila}
\par Pada gambar tersebut dapat dilihat bahwa untuk layer pertama densenya dari 100 neuron kemudian untuk inputan activationnya menggunakan fungsi relu ( nilai maksimum yang akan dipilih ). Dense 10 mengkategorikan 10 neuron untuk jenis genrenya untuk keluarnnya menggunakan aktivasi yaitu fungsi Softmax.
\begin{figure}[!hbtp]
\centering
\includegraphics[scale=0.2]{figures/fungsi-sequential-fadila.jpg}
...
\item Jelaskan kenapa harus dilakukan pemisahan data training dan data set sebesar 80 persen?
	...
	\par Berikut adalah kode program yang digunakan :
	\lstinputlisting[firstline=8, lastline=20]{src/1164080/6-lusia.py}
...
\item Fungsi Sequential()
	...
	\lstinputlisting[firstline=8, lastline=20]{src/1164080/7-lusia.py}
	...
	\par Setelah program dijalankan, maka akan menghasilkan seperti pada gambar \ref{6B8}.
		...
		\begin{figure}[!hbtp]
		\centering
		\includegraphics[scale=0.4]{figures/t7.jpg}
		\caption{Lusia-Hasil Sequential}
		\label{6B8}
		\end{figure}
		
	\par Penjelasan gambar \ref{6B8}:
	\begin{enumerate}
...
\item Fungsi compile()
	\par Kode program yang digunakan adalah sebagai berikut :
	\lstinputlisting[firstline=8, lastline=20]{src/1164080/8-lusia.py}
	\par Penjelasan parameter :
	\begin{itemize}
	...
	\par Setelah program dijalankan, maka akan menghasilkan seperti pada gambar \ref{6B9}.
	
		\begin{figure}[!hbtp]
		\centering
		\includegraphics[scale=0.4]{figures/t8.jpg}
		\caption{Lusia-Hasil Compile}
		\label{6B9}
		\end{figure}
		
	\par Berikut adalah penjelasan gambar \ref{6B9} :
	\begin{enumerate}
...
\item Fungsi fit()
	\par Kode program yang digunakan adalah sebagai berikut :
	\lstinputlisting[firstline=8, lastline=20]{src/1164080/9-lusia.py}
	...
	\par Apabila kode program tersebut dijalankan, maka akan menghasilkan seperti pada gambar \ref{6B10}.
	
		\begin{figure}[!hbtp]
		\centering
		\includegraphics[scale=0.4]{figures/t9.jpg}
		\caption{Lusia-Hasil Fungsi Fit}
		\label{6B10}
		\end{figure}
		
	\par Penjelasan hasil, perhatikan gambar \ref{6B10} :
	\begin{enumerate}
	...
	\par Dari gambar \ref{6B10} kita dapat melihat bahwa setiap satu epoch terdapat nilai akurasi dan loss.

\item Fungsi evaluate()
	\par Berikut adalah kode program yang digunakan :
	\lstinputlisting[firstline=8, lastline=20]{src/1164080/10-lusia.py}
	...
	\par Apabila kode program tersebut dijalankan, maka akan menghasilkan seperti pada gambar \ref{6B11}.
	
		\begin{figure}[!hbtp]
		\centering
		\includegraphics[scale=0.4]{figures/t10.jpg}
		\caption{Lusia-Hasil Fungsi Evaluate}
		\label{6B11}
		\end{figure}
		
	\par Penjelasan hasil pada gambar \ref{6B11} :
	\begin{enumerate}
...
\item Fungsi predict()
	\par Berikut adalah kode program yang digunakan :
	\lstinputlisting[firstline=8, lastline=20]{src/1164080/11-lusia.py}
	\par Parameter yang digunakan pada kode program :
	\begin{itemize}
	\item [:1] = digunakan untuk menentukan batasa row.
	\end{itemize}
	
	\par Apabila kode program tersebut dijalankan, maka akan menghasilkan seperti pada gambar \ref{6B12}.
	
		\begin{figure}[!hbtp]
		\centering
		\includegraphics[scale=0.4]{figures/t11.jpg}
		\caption{Lusia-Hasil Fungsi Predic}
		\label{6B12}
		\end{figure}
		
	\par Penjelasan hasil pada gambar \ref{6B12} :
	\begin{enumerate}
